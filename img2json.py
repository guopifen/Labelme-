...
class img_to_json(object):
    """
        这ge类是用来将图像数据转化成json文件的，方便下一步的处理。主要是为了获取
        图像的字符串信息
    """
    ...
    #             out_file_type=".json"):
    def __init__(self, process_img_path="C:\\Users\\Lsk\\Desktop\\RGB_N\\matlab\\rgb_imgs\\",
                 img_type=".png",
                 out_file_path="C:\\Users\\Lsk\\Desktop\\RGB_N\\matlab\\img_to_json\\",
                 out_file_type=".json"):
        """
